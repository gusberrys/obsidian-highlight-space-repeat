...
export type KeywordStyle = {
  ...
  description?: string;
  generateIcon?: string;  // Icon for normal keywords (inserted via JS)
  ...
  isColorKeyword?: boolean;  // Marks keywords auto-generated from color entries (gvr, grr, lvr, lrr, etc.)
  sourceColorCC?: string;    // Tracks which color entry generated this keyword (e.g., "r" for red)
  colorIcon?: string;        // Icon for color keywords (inserted via CSS ::before)
};
